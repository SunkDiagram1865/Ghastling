...
本仓库包含以下核心文件与目录，其余文件均为上游 Modrinth Website 或分支 Axolotl Website 的遗留内容，与本项目无关。

```
.
├── index.html # 网站主页面
├── ghastling.png # 小乐魂 Logo 图标
├── ghastling_background.png # 背景图片
├── sounds/ # 网站音效资源目录
│ └── ... # 音效文件
└── README.md # 项目说明文档
```
